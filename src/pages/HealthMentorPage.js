  ...
  return (
    <Layout ambient>
      <div className="space-y-6" data-testid="health-mentor-page">
        ...
        {/* Slice 1 reads no personal health record. Saying so plainly beats
            letting the answers imply an access that does not exist yet. */}
        <div
          role="note"
        ...
        >
          ...
          <p className="text-muted-foreground leading-snug">
            Todavía no consulto tus registros de salud: te respondo con orientación
            general. No sustituyo a un profesional sanitario.
          </p>
        </div>
