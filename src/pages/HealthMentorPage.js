...
import HealthActivityTab from '../components/health/HealthActivityTab';
...
import { Activity, Clock, HeartPulse, Info, NotebookPen, PlusCircle, Rocket, RotateCcw, Send } from 'lucide-react';
  ...
  return (
    <Layout ambient>
      <div className="space-y-6" data-testid="health-mentor-page">
        <ProfileHeroCard
          title="Mentor de Salud"
          titleAs="h1"
          description="Alimentación, entrenamiento, descanso y composición corporal."
          action={
        ...
        <Tabs defaultValue="conversacion" className="space-y-4">
          <TabsList>
            <TabsTrigger value="conversacion" className="gap-1.5">
              <HeartPulse className="w-3.5 h-3.5" /> Conversación
            </TabsTrigger>
          ...
          <TabsContent value="conversacion" className="space-y-4">
          ...
          >
            ...
            <p className="text-muted-foreground leading-snug">
              Recuerdo lo que me cuentas entre conversaciones, si lo permites en la pestaña
              "Notas". No sustituyo a un profesional sanitario.
            </p>
          </div>
